        ...
        "columns": [
...

            {
                ...
                "render": function (data, type, row) {
                    return '<button class="btn btn-light btn-sm " data-placement="left" data-toggle="tooltip" data-animation="false" title="Edit" onclick=" select(); GetById(\'' + row.nik + '\')"><i class="bi bi-pencil-fill"></i></button >' + '&nbsp;' +
